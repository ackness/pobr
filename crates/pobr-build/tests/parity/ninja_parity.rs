...
const BASELINE_DEF_HIT5: usize = 444; // #14 长尾分诊后 444/450（#12 companion 431；存量 #7-3/4 425；Communion+Voices 413（ArmourAppliesTo 410；Refraction 407；ItemES 405；Barrier-Life 401；Mageblood 393；迁移基线 343；0.5.0=415）
const BASELINE_DEF_HIT10: usize = 444; // #14 长尾分诊后 444/450（#12 companion 439；Communion+Voices 434；Refraction 429；ItemES 428；Barrier-Life 425；Mageblood 417；迁移基线 361；0.5.0=432）

...
- Shared page headers, card/control tokens and slot symbols live under `web/src/components/shared` and `web/src/styles`. UI verification covers all seven tabs and 320/768/1024/1440 breakpoints with real WASM.

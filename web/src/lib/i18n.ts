...
const DICT = {
  ...
  "build.importHint": {"en-US": "Paste a PoB2 code, WeGame share link or .build JSON. The selected destination controls where the imported character, equipment, skills and tree are saved.", "zh-TW": "貼上 PoB2 代碼、WeGame 分享連結或 .build JSON。匯入的角色、裝備、技能與天賦會儲存至上方選擇的位置。", "zh-CN": "粘贴 PoB2 代码、WeGame 分享链接或 .build JSON。导入的角色、装备、技能与天赋会保存到上方选择的位置。"},
  "build.importing": {"en-US": "Importing build…", "zh-TW": "正在匯入構築…", "zh-CN": "正在导入构筑…"},
  "build.confirmClassChange": {"en-US": "Reset this stage to an empty level 1 character of this class? Its equipment, skills, passives, notes and configuration will be cleared. Copy the stage first to keep it.", "zh-TW": "要將目前階段重設為此職業的 1 級空白角色嗎？此階段的裝備、技能、天賦、筆記與配置將被清除。如需保留，請先複製階段。", "zh-CN": "要将当前阶段重置为此职业的 1 级空白角色吗？此阶段的装备、技能、天赋、笔记与配置将被清除。如需保留，请先复制阶段。"},
  ...
  "ui.buildHint": {"en-US": "Choose a build, then edit its current stage. Use stages to plan leveling, progression and endgame.", "zh-TW": "選擇 BD 後編輯目前階段，透過階段規劃開荒、過渡與畢業。", "zh-CN": "选择 BD 后编辑当前阶段，通过阶段规划开荒、过渡与毕业。"},
  ...
  "build.newHint": {"en-US": "Changing class resets this stage to an empty level 1 character. Use New build to start a separate build.", "zh-TW": "更換職業會將目前階段重設為 1 級空白角色。建立獨立 BD 請使用「新增 BD」。", "zh-CN": "更换职业会将当前阶段重置为 1 级空白角色。创建独立 BD 请使用「新建 BD」。"},
  ...
  "build.importButton": {"en-US": "Import as new build", "zh-TW": "匯入為新 BD", "zh-CN": "导入为新 BD"},
  ...
  "config.groupTitle": {"en-US": "Group title", "zh-TW": "分組名稱", "zh-CN": "分组名称"},
  "config.groupEnabled": {"en-US": "Enable group", "zh-TW": "啟用分組", "zh-CN": "启用分组"},
  "config.groupText": {"en-US": "Modifier text", "zh-TW": "詞綴文字", "zh-CN": "词缀文本"},
  "config.groupAdd": {"en-US": "Add group", "zh-TW": "新增分組", "zh-CN": "添加分组"},
  "config.groupRemove": {"en-US": "Remove group", "zh-TW": "移除分組", "zh-CN": "删除分组"},
  "config.groupUntitled": {"en-US": "Untitled group", "zh-TW": "未命名分組", "zh-CN": "未命名分组"},
  'config.extraModsHint': {
    'en-US':
      'One modifier per line (PoB text, e.g. "20% increased Fire Damage"); Only enabled groups apply; text is saved when you leave the field. Unparsable lines show up in the Build tab unsupported list.',
    'zh-TW': '一行一條詞綴（PoB 文本，如「20% increased Fire Damage」），僅啟用的分組生效，離開輸入框即儲存；無法解析的行會出現在構築頁的不支援清單。',
    'zh-CN': '一行一条词缀（PoB 文本，如「20% increased Fire Damage」），仅启用的分组生效，离开输入框即保存；无法解析的行会出现在构筑页的不支持列表。',
  },
